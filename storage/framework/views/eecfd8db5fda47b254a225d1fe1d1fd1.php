<header class="bg-airbnb-dark text-white py-3 px-8 flex justify-between items-center fixed top-0 left-0 right-0 z-50 h-20 w-full">
    ...
    <div x-data="{ open: false }" class="relative">
        ...
        <div
            ...
            style="display: none;"
        >
            <a href="<?php echo e(route('login')); ?>" class="block py-[0.35rem] px-2 text-gray-800 hover:bg-[#FBFFF6] rounded font-medium">Log in</a>
            <a href="<?php echo e(route('signup')); ?>" class="block py-[0.35rem] px-2 text-gray-800 hover:bg-[#FBFFF6] rounded font-medium">Sign up</a>
            <a href="<?php echo e(route('login')); ?>" class="block py-[0.35rem] px-2 text-gray-800 hover:bg-[#FBFFF6] rounded font-medium">AirBnB your house</a>
            <a href="<?php echo e(route('login')); ?>" class="block py-[0.35rem] px-2 text-gray-800 hover:bg-[#FBFFF6] rounded font-medium">About us</a>
            <a href="<?php echo e(route('login')); ?>" class="block py-[0.35rem] px-2 text-gray-800 hover:bg-[#FBFFF6] rounded font-medium">Help Center</a>
        </div>
    </div>
</header>
